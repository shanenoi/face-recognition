...
def recognition_face(img):
    face_locations = face_recognition.face_locations(image_less_noise)
    face_encodings = face_recognition.face_encodings(image_less_noise, face_locations)
    face_names = []
...
# plt.subplot(211),plt.imshow(image_rgb)
# plt.subplot(212),plt.imshow(image_recognize_face)
# plt.show()
